...
# 10.5 OOTB Bus Objects
   set thelist [ list \
      ...
      "Company,Route Templates" \
      "Company,Design Responsibility" \
      "Company,Division" \
      "Company,Company Financial Categories" \
      "Business Unit,Organization Representative" \
      "Business Unit,Design Responsibility" \
      "Business Unit,Organization Region" \
      "Business Unit,Supported Organization" \
      "Route,Route Node" \
      "Route Template,Route Node" \
      "Financial Benefit Category,Financial Sub Categories" \
      "Financial Cost Category,Financial Sub Categories" \
      "Issue Category,Issue Category Classification" \
   ]
