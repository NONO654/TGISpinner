...
# 10.5 Common Doc Model (CDM)
   set thelist [ list \
      "Document,Version" \
      "Document,Vaulted Objects" \
      "Document,Reference Document" \
      "Document,Object Route" \
      "Document,Part Family Reference Document" \
      "Document,Vaulted Documents Rev2" \
      "Document,Task Deliverable" \
      "Document Sheet,Version" \
      "Document Sheet,Document Sheets" \
      "Drawing Print,Part Family Reference Document" \
      "Drawing Print,Part Specification" \
      "Drawing Print,Reference Document" \
      "Drawing Print,New Specification / Specification Revision" \
      "Drawing Print,Markup" \
      "Generic Document,Version" \
      "Generic Document,Has Documents" \
      "Generic Document,Document Sheets" \
      "Generic Document,Vaulted Documents Rev2" \
      "CAD Drawing,New Specification / Specification Revision" \
      "CAD Drawing,Part Specification" \
      "CAD Model,Part Specification" \
      "CAD Model,Reference Document" \
      "MCAD Component Instance,Part Specification" \
      "Design Specification,Version" \
      "Design Specification,Product Specification" \
      "Markup,Markup" \
      "Markup,ECR Supporting Document" \
      "Sketch,ECR Supporting Document" \
